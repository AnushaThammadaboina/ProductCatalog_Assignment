...
- Create Angular project with ng: `ng new productcatalogs.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`productcatalogs.client.esproj`).
